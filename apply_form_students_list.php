...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="card">
            ...
            <?php 
                if (isset($_SESSION['student_apply_success'])){ ?>
            <div class=" alert alert-success alert-dismissible">
                <?php echo $_SESSION['student_apply_success'] ?>
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">X</button>
            </div>
            <?php unset($_SESSION['student_apply_success']);  }
            ...
            <div class=" alert alert-success alert-dismissible">
                <?php echo $_SESSION['student_delete_success'] ?>
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">X</button>
            </div>
            <?php unset($_SESSION['student_delete_success']);  }
            
            ?>

            <?php 
                if (isset($_SESSION['update_student_data_success'])){ ?>
            <div class=" alert alert-success alert-dismissible">
                <?php echo $_SESSION['update_student_data_success'] ?>
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">X</button>
            </div>
            <?php unset($_SESSION['update_student_data_success']);  }
            
            ?>

            <?php 
                if (isset($_SESSION['student_delete_error'])){ ?>
            <div class=" alert alert-danger alert-dismissible">
                <?php echo $_SESSION['student_delete_error'] ?>
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">X</button>
            </div>
            <?php unset($_SESSION['student_delete_error']);  }
            
            ?>

            <?php 
                if (isset($_SESSION['generate_certificate_error'])){ ?>
            <div class=" alert alert-danger alert-dismissible">
                <?php echo $_SESSION['generate_certificate_error'] ?>
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">X</button>
            </div>
            <?php unset($_SESSION['generate_certificate_error']);  }
                ...
                <div class=" table-responsive mb-5">
                    <table class="table table-bordered text-center">
                        ...
                        <tbody>
                            <?php 
                                $sn=1;
                                $sql = "SELECT * FROM apply_form_students";
                            ...
                            <tr>
                                ...
                                <td style="max-width: 150px; overflow: hidden; text-overflow: ellipsis;">
                                    ...
                                    <a href="#" onclick="openReceiptModal('<?php echo $row['r_id']; ?>')">View
                                        Receipt</a>
                                    <div id="ReceiptModal" class="modal">
                                        <div class="modal-content">
                                            <img id="ReceiptImage" src="uploads/<?php echo $row['r_id']; ?>"
                                                alt="Receipt">
