...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="card">
            ...
            <?php 
                if (isset($_SESSION['course_update_success'])){ ?>
            <div class=" alert alert-success alert-dismissible">
                <?php echo $_SESSION['course_update_success'] ?>
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">X</button>
            </div>
            <?php unset($_SESSION['course_update_success']);  }
            ...
            <?php 
                if (isset($_SESSION['course_delete_success'])){ ?>
            <div class=" alert alert-success alert-dismissible">
                <?php echo $_SESSION['course_delete_success'] ?>
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">X</button>
            </div>
            <?php unset($_SESSION['course_delete_success']);  }
            
            ?>

            <?php 
                if (isset($_SESSION['course_delete_error'])){ ?>
            <div class=" alert alert-danger alert-dismissible">
                <?php echo $_SESSION['course_delete_error'] ?>
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">X</button>
            </div>
            <?php unset($_SESSION['course_delete_error']);  }
                                ...
                                <td>
                                    ...
                                    <div id="imageModal" class="modal">
                                        <div class="modal-content">
                                            <img id="image" src="uploads/<?php echo $row['image'] ?>" alt="image">
